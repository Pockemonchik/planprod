    ...
    class Meta:
        ...
        widgets = {
            ...
            'data': TextInput(attrs={'placeholder': '31 февраля 2019', 'class': 'form-control',
                                     'id': 'address'}),
            'na_kakoygod': TextInput(attrs={'placeholder': '2019', 'class': 'form-control dataNaKakoyGod',
                                            'id': 'address'}),
            'na_kakoygod1': TextInput(attrs={'placeholder': '2020', 'class': 'form-control dataNaKakoyGod',
                                             'id': 'address'}),
